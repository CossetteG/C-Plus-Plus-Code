...
bool assert_values(int* key, Vector<int>& vec) {
    bool failure = false;
...
int main() {
    ...
    try {
        Vector<int> vecOne = Vector<int>(5, valsOne); // testing initial constructor
        Vector<int> vecTwo = Vector<int>(10, valsTwo);
        Vector<int> vecThree = Vector<int>(5, valsThree);
        Vector<int> vecFive = Vector<int>();
        pass ++;
        ...
        Vector<int> vecFour = vecOne; // testing copy constructors
        ...
        Vector<int> vecSix = Vector<int>(5, valsOne);
        vecThree = vecOne;      
